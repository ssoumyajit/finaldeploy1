            ...
            <v-row class="pa-4">
                ...
                <v-col cols="12" md="6" class="pl-6">
                    ...
                    <v-dialog v-model="personalDialog" width="800px" v-if="isAuthenticated && userHasPortfolio && isYourRoom">
                        <template v-slot:activator="{ on, attrs }">
                            <v-badge color="error" overlap :content='personal_notify'>
...
export default {
    ...
    methods:{
        ...
        async submitLearning(){
            ...
            try {
                if(this.putVideo.name != undefined)
                {
                ...
                if(res.statusCode == 200)
                {
                    ...
                    console.log(this.putVideo);
                    s3form.append("key", this.putVideo);
                    ...
                    // }
                    //  this.$axios.$post("/v1/e1t1/learnings/", formData, config);
